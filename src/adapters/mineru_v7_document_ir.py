...
def metadata_from_v7_item(item: dict[str, Any], *, include_raw_block: bool, include_raw_item: bool) -> dict[str, Any]:
    metadata_keys = (
        ...
        "raw_sub_type",
        "mineru_subtype",
        "content_list_raw_type",
        "is_algorithm_subtype",
        "algorithm_origin",
        "algorithm_confidence",
        "algorithm_body_ids",
        "algorithm_caption_ids",
        "raw_formula_type",
        "mineru_span_type",
        "formula_latex",
        "text_format",
        ...
        "content_list_type",
        "content_list_bbox_1000",
        "content_list_match_score",
        "content_list_text",
        "content_list_text_iou",
        "content_list_text_candidates",
        "source_block_ids",
        "source_middle_indices",
        "source_page_indices",
        "source_line_ids",
        "source_lines",
        "text_source",
        "middle_text",
        "style_content_list_json",
        "style_content_list_index",
        "style_content_list_match_score",
        "style_content_list_iou",
        "column_id",
        "merge_chain_length",
        "merge_reasons",
        "is_main_flow_candidate",
